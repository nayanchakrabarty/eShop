...
Route::get('/newmobile', 'HomeController@newMobile')->name('newmobile');

Route::get('/filters', 'FilterTabsController@filters')->name('filters');
Route::get('/detail/{id}', 'MobileDetailsController@index')->name('mobiledetail');


Route::get('/pricing', 'HomeController@pricing')->name('pricing');
Route::get('/privacy-policy', 'HomeController@privacyPolicy')->name('home.privacyPolicy');
Route::get('/term-of-service', 'HomeController@termOfService')->name('home.termOfService');
Route::get('/{pageSlug?}', 'HomeController@page')->name('page');

Route::post('/contact_us_message', 'ContactUsController@store')->name('contact_us_message.store');

Route::get('/products/{productId}', 'HomeController@productDetails')
    ->name('productDetails')
    ->where('productId', '[0-9]+');
...
Route::get('/help-center/{productId}/{categoryId?}/{articleId?}', 'HomeController@helpCenter')
    ->name('home.helpCenter')
    ->where('productId', '[0-9]+')
...
Route::group([
    ...
    Route::get('/settings/profile', 'MemberController@profile')
        ->name('members.settings.profile');
    Route::get('/settings/changepassword', 'MemberController@changePass')
        ->name('members.settings.changepassword');
    Route::get('/settings/mystores', 'MemberController@userStores')
        ->name('members.settings.mystores');
    Route::get('/settings/orders', 'MemberController@userOrders')
        ->name('members.settings.orders');

    Route::get('/settings/addons/{storeId}', 'MemberController@userStoreAddons')
        ->name('members.settings.addons');
...
Route::group(
[
    'prefix' => 'admin/bank_informations',
    'middleware' => ['auth', 'checkPermission']
], function () {

    Route::get('/', 'BankInformationsController@index')
         ->name('bank_informations.index');

    Route::get('/create','BankInformationsController@create')
         ->name('bank_informations.create');

    Route::get('/show/{bankInformation}','BankInformationsController@show')
         ->name('bank_informations.show')
         ->where('id', '[0-9]+');

    Route::get('/{bankInformation}/edit','BankInformationsController@edit')
         ->name('bank_informations.edit')
         ->where('id', '[0-9]+');

    Route::post('/', 'BankInformationsController@store')
         ->name('bank_informations.store');

    Route::put('bank_information/{bankInformation}', 'BankInformationsController@update')
         ->name('bank_informations.update')
         ->where('id', '[0-9]+');

    Route::delete('/bank_information/{bankInformation}','BankInformationsController@destroy')
         ->name('bank_informations.destroy')
         ->where('id', '[0-9]+');
});
...
[
    ...
    Route::get('/', 'StoragesController@index')
         ->name('storages.index');

    Route::get('/create','StoragesController@create')
         ->name('storages.create');

    Route::get('/show/{storage}','StoragesController@show')
         ->name('storages.show')
         ->where('id', '[0-9]+');

    Route::get('/{storage}/edit','StoragesController@edit')
         ->name('storages.edit')
         ->where('id', '[0-9]+');

    Route::post('/', 'StoragesController@store')
         ->name('storages.store');

    Route::put('storage/{storage}', 'StoragesController@update')
         ->name('storages.update')
         ->where('id', '[0-9]+');

    Route::delete('/storage/{storage}','StoragesController@destroy')
         ->name('storages.destroy')
         ->where('id', '[0-9]+');
});
...
[
    ...
    Route::get('/', 'RamsController@index')
         ->name('rams.index');

    Route::get('/create','RamsController@create')
         ->name('rams.create');

    Route::get('/show/{ram}','RamsController@show')
         ->name('rams.show')
         ->where('id', '[0-9]+');

    Route::get('/{ram}/edit','RamsController@edit')
         ->name('rams.edit')
         ->where('id', '[0-9]+');

    Route::post('/', 'RamsController@store')
         ->name('rams.store');

    Route::put('ram/{ram}', 'RamsController@update')
         ->name('rams.update')
         ->where('id', '[0-9]+');

    Route::delete('/ram/{ram}','RamsController@destroy')
         ->name('rams.destroy')
         ->where('id', '[0-9]+');
});
