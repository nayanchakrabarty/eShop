    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @if (App\Helpers\CommonHelper::isCapable('currencies.index'))
                    <li {{ (Request::routeIs('currencies.*') ? 'class=active' : '') }}>
                        <a href="{{ route('currencies.index') }}">
                            <i class="fa fa-eur"></i> <span>Currencies</span>
                        </a>
                    </li>
                @endif

                @if (App\Helpers\CommonHelper::isCapable('regions.index'))
                    <li {{ (Request::routeIs('regions.*') ? 'class=active' : '') }}>
                ...
                @if (App\Helpers\CommonHelper::isCapable('storages.index'))
                    <li {{ (Request::routeIs('storages.*') ? 'class=active' : '') }}>
                        <a href="{{ route('storages.index') }}">
                            <i class="fa fa-database"></i> <span>Storages</span>
                        </a>
                    </li>
                @endif

                @if (App\Helpers\CommonHelper::isCapable('rams.index'))
                    <li {{ (Request::routeIs('rams.*') ? 'class=active' : '') }}>
                        <a href="{{ route('rams.index') }}">
                            <i class="fa fa-microchip"></i> <span>Rams</span>
                        </a>
                    </li>
                @endif

                @if (App\Helpers\CommonHelper::isCapable('variation_prices.index'))
                    <li {{ (Request::routeIs('variation_prices.*') ? 'class=active' : '') }}>
