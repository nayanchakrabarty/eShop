                                        ...
                                        <table id="dataTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ number_format($order->paid_amount, 2) }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif ($order->status == 'Cancel' || $order->status ==
                                                        'Failed')
                                                    ...
                                                    <td class="text-center" style="min-width:80px;">
                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            ==
                                                            'Bank')
                                                            <button class="btn btn-xs btn-primary btn-bank"
                                                                type="button" data-order-id="{{ $order->id }}">
                                                            ...
                                                            ==
                                                            'bKash')
                                                            <button class="btn btn-xs btn-primary btn-bkash"
                                                                type="button" data-order-id="{{ $order->id }}">
                                                                <i class="fa fa-upload" aria-hidden="true"></i>
                                                            </button>
                                                            @endif
                                                            ...
                                                            <a href="{{ route('members.printInvoice', $order->id) }}"
                                                                class="btn btn-xs btn-warning" title="Print Invoice">
